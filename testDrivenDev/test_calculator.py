...
class TestCalculator(unittest.TestCase):
    ...
    def test_add_none_numbers_raises_type_error(self):
        self.assertRaises(TypeError, self.calculator.add, "Hello, Paul")
        self.assertRaises(TypeError, self.calculator.add, 20, "Paul")
        self.assertRaises(TypeError, self.calculator.add, "Paul", 20)
