...
def add_watermark_overlay(input_image_path, output_image_path, watermark_text):
    ...
    font_size = 80
    font = ImageFont.truetype('/Library/Fonts/Arial Black.ttf', font_size)

    text_width, text_height = draw.text((0, 0), text=watermark_text, font=font)
...
input_image_path = 'manchester.jpeg'
output_image_path = 'manchester.png'
watermark_text = 'PaulT Image'
