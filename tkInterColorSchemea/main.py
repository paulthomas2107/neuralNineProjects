...
def apply_theme(theme):
    ...
    textbox.config(fg=theme["foreground"], bg=theme["background"], font=(theme["font"], theme["fontsize"]))
    button.config(fg=theme["foreground"], bg=theme["background"], font=(theme["font"], theme["fontsize"]))
    option_menu.config(fg=theme["foreground"], bg=theme["background"], font=(theme["font"], theme["fontsize"]))
...
def show_custom_message():
    ...
    msg = tk.Label(popup, text=textbox.get(), fg=current_theme["messagebox_fg"], bg=current_theme["messagebox_bg"])
...
option_menu = tk.OptionMenu(app, theme_var,"Classic Elegance", "Midnight Oasis", "Ocean Breeze", "Soft Serenity", "Sunset Glow")
